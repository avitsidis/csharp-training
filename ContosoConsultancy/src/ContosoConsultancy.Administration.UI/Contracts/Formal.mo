...
This Consulting Agreement (the “Agreement” or “Consulting Agreement”) states the terms and conditions that govern the contractual agreement between Contoso Consultancy  , and {{Customer}} (the “Client”) who agrees to be bound by this Agreement.
...
This Agreement shall begin on {{StartDate}} and end on {{EndDate}}.
a. Either Party may terminate this Agreement for any reason written notice to the other Party.
2. Consulting Services

The Consultant agrees that it shall provide its expertise to the Client for all things pertaining to ICT (the “Consulting Services”).
3. Compensation

In consideration for the Consulting Services, the Client shall pay the Consultant at the rate of {{Rate}} euros per day. The Consultant shall invoice the Client once every [TIME FRAME] and such invoices shall be due and payable within [TIME FRAME] days of the Client’s receipt of the invoice.
...
During the term of this Agreement, the Consultant shall not engage, directly or indirectly, as an employee, officer, manager, partner, manager, consultant, agent, owner or in any other capacity, in any competition with the Client or any of its subsidiaries, including any company engaged in ICT.
7. Nonsolicitation of Customers

During the term of this Agreement, the Consultant will not, directly or indirectly, solicit or attempt to solicit any business from any of the Company’s clients, prospects, employees or contractors.
...
Contoso Consultancy Responsible
