...
namespace ContosoConsultancy.Rest.Client.ContosoConsultancyRest
{
    ...
    public partial class Consultants : IServiceOperations<ContosoConsultancyRestClient>, IConsultants
    {
        ...
        /// </return>
        public async Task<HttpOperationResponse<IList<ConsultantModel>>> GetConsultantsWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Tracing
